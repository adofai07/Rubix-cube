class Cube:
    ...
    def move(self, move: str) -> None:
        ...
        if move == "U":
            for _ in range(rep):
                self.arr[10], self.arr[11], self.arr[12], self.arr[13], self.arr[15], self.arr[16], self.arr[17], self.arr[18], self.arr[34], self.arr[35], self.arr[36], self.arr[21], self.arr[20], self.arr[19], self.arr[3], self.arr[2], self.arr[1], self.arr[39], self.arr[38], self.arr[37] = self.arr[16], self.arr[13], self.arr[10], self.arr[17], self.arr[11], self.arr[18], self.arr[15], self.arr[12], self.arr[39], self.arr[38], self.arr[37], self.arr[34], self.arr[35], self.arr[36], self.arr[21], self.arr[20], self.arr[19], self.arr[3], self.arr[2], self.arr[1]
